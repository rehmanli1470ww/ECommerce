...
public partial class NorthwindContext : DbContext
{
    ...
    {
        return obj is NorthwindContext context &&
               base.Equals(obj) &&
               EqualityComparer<IConfiguration>.Default.Equals(_configuration, context._configuration);
    }

    public override int GetHashCode()
    {
        return HashCode.Combine(base.GetHashCode(), _configuration);
    }
